<template><h2 id="进程和线程" tabindex="-1"><a class="header-anchor" href="#进程和线程" aria-hidden="true">#</a> 进程和线程</h2>
<p>一个进程可以含有一个至多个线程。</p>
<p>每用 java 命令启动一个 java 应用程序，就会启动一个 jvm 进程，该进程中包含了一些默认的线程和开发者启动的线程。</p>
<h2 id="并行和并发" tabindex="-1"><a class="header-anchor" href="#并行和并发" aria-hidden="true">#</a> 并行和并发</h2>
<p>并行是指真正意义上的“同时进行“，而并发指<strong>某一段时间</strong>内”同时进行“。</p>
<h2 id="创建线程的三种方式" tabindex="-1"><a class="header-anchor" href="#创建线程的三种方式" aria-hidden="true">#</a> 创建线程的三种方式</h2>
<ul>
<li>通过继承<code>Thread</code>类，重写<code>run</code>方法；</li>
<li>通过实现<code>runable</code>接口；</li>
<li>通过实现<code>callable</code>接口。</li>
</ul>
<h2 id="线程的六种状态" tabindex="-1"><a class="header-anchor" href="#线程的六种状态" aria-hidden="true">#</a> 线程的六种状态</h2>
<p>可以通过<code>getState</code>获取线程当前的状态：</p>
<ul>
...
<h3 id="为什么六种状态有-runnable-而没有-running" tabindex="-1"><a class="header-anchor" href="#为什么六种状态有-runnable-而没有-running" aria-hidden="true">#</a> 为什么六种状态有 Runnable 而没有 Running</h3>
<p>上述六种状态是 jvm 定义的 java 线程的状态，而不是操作系统层面的线程的状态。</p>
<p>在 jvm 层面只能对线程做到<code>Runnable</code>细粒度的定义，更细分的状态依赖操作系统具体的调度。</p>
<h3 id="状态转移图" tabindex="-1"><a class="header-anchor" href="#状态转移图" aria-hidden="true">#</a> 状态转移图</h3>
...
<h2 id="中断线程" tabindex="-1"><a class="header-anchor" href="#中断线程" aria-hidden="true">#</a> 中断线程</h2>
<p>调用<code>interrupt</code>并不直接终结目标线程的执行，而是修改了目标线程的中断标志，至于具体做什么事情由目标线程自身决定。</p>
...
<li>
<p><code>interrupted</code>会有清除中断标志的副作用。</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">InterruptedException</span> <span class="token punctuation">{</span>
        <span class="token class-name">Thread</span> threadOne <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Thread</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">-></span> <span class="token punctuation">{</span>
            <span class="token comment">//noinspection StatementWithEmptyBody</span>
...
<h2 id="volatile" tabindex="-1"><a class="header-anchor" href="#volatile" aria-hidden="true">#</a> volatile</h2>
<h3 id="改变可见性" tabindex="-1"><a class="header-anchor" href="#改变可见性" aria-hidden="true">#</a> 改变可见性</h3>
<p><code>volatile</code>关键字的目的是告诉 jvm：</p>
<ul>
<li>每次访问变量时，总是获取主内存的最新值；</li>
<li>每次修改变量后，立刻回写到主内存。</li>
</ul>
<p>当一个线程修改了某个共享变量的值，其他线程能够立刻看到修改后的值。</p>
<h3 id="禁止指令重排" tabindex="-1"><a class="header-anchor" href="#禁止指令重排" aria-hidden="true">#</a> 禁止指令重排</h3>
<p>加<code>volatile</code>后，编译器会在读写该变量的时候添加对应的内存屏障，防止了指令重排。</p>
<table>
<thead>
<tr>
...
<td style="text-align:left">该屏障确保Load1数据的装载先于Load2及其后所有装载指令的的操作</td>
</tr>
<tr>
<td style="text-align:left">StoreStore Barriers</td>
<td style="text-align:left">Store1;StoreStore;Store2</td>
<td style="text-align:left">该屏障确保Store1立刻刷新数据到内存(使其对其他处理器可见)的操作先于Store2及其后所有存储指令的操作</td>
</tr>
<tr>
...
<td style="text-align:left">该屏障确保Store1立刻刷新数据到内存的操作先于Load2及其后所有装载装载指令的操作。它会使该屏障之前的所有内存访问指令(存储指令和访问指令)完成之后,才执行该屏障之后的内存访问指令</td>
</tr>
</tbody>
</table>
<p>基于<strong>保守策略</strong>的 JMM 内存屏障插入策略：</p>
<ul>
<li>
...
<p>可以用在静态方法、实例方法或代码块上，保证了：</p>
<ul>
<li>原子性，线程互斥的访问同步代码。</li>
<li>可见性，加锁时清空工作内存中共享变量的值，解锁时同步工作内存中共享变量的值到主内存。</li>
</ul>
<p><strong>懒汉式单例模式的双重锁检查(dcl)</strong></p>
<p>同时应用 synchronized 和 volatile 的特性的案例</p>
...
<li>
<p><code>synchronized</code>保证了<code>new</code>操作的原子性，加上第二次的判空，可以确保不会<code>new</code>出多个实例；</p>
</li>
<li>
<p><code>volatile</code>保证了<code>instance</code>的初始化。如果没有<code>volatile</code>会产生以下情况：</p>
</li>
</ol>
...
<p><code>ThreadLocal</code> 隔离了的变量的作用域，提供了线程本地变量，让线程内的上下文共享更方便。</p>
<h3 id="withinitial-和-initialvalue" tabindex="-1"><a class="header-anchor" href="#withinitial-和-initialvalue" aria-hidden="true">#</a> withInitial 和 initialValue</h3>
<p>当没调用过<code>set</code>而直接调用<code>get</code>时，会用<code>initialValue</code>设置初始值，默认的实现是一个返回<code>null</code>的方法，可以继承<code>ThreadLocal</code>重写该方法为线程本地变量提供初始值。</p>
<p>更简便的方式是使用<code>ThreadLocal</code>的<code>withInitial</code>的静态方法，传入一个<code>Supplier</code>即可：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h3 id="inheritablethreadlocal-和-childvalue" tabindex="-1"><a class="header-anchor" href="#inheritablethreadlocal-和-childvalue" aria-hidden="true">#</a> InheritableThreadLocal 和 childValue</h3>
<p>使用<code>InheritableThreadLocal</code>时，新建的子线程时可以继承父线程的线程本地变量，</p>
<p>并且可以通过重写<code>childValue</code>方法来设置继承后的新值。</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">InheritableThreadLocalDemo</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h3 id="实现细节" tabindex="-1"><a class="header-anchor" href="#实现细节" aria-hidden="true">#</a> 实现细节</h3>
...
<p><code>ThreadLocal</code>可是说是一个<strong>工具类</strong>，实际存数据的<code>map</code>是放在每一个线程类的属性之中的。</p>
<h3 id="实践" tabindex="-1"><a class="header-anchor" href="#实践" aria-hidden="true">#</a> 实践</h3>
<h4 id="为什么使用弱引用" tabindex="-1"><a class="header-anchor" href="#为什么使用弱引用" aria-hidden="true">#</a> 为什么使用弱引用</h4>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>public void foo() {
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>考虑上面的代码，在 bar 中调用了很多次 foo，每次调用都创建了一个 ThreadLocal 对象，他们都会形成 Entry 放入 ThreadLocalMap 中，如果 Entry 使用强引用，那么堆中 ThreadLocal 对象就永远不会回收，就会造成内存泄漏，而如果采用弱引用，只要栈不引用 ThreadLocal，它就能被回收，回收后 Entry 就变成 k 为 null 的 stale entry 了，这样 ThreadLocal 在执行 set、get、remove 时可以根据 k 是否为 null 识别 stale entry 并进行清除，大大避免了内存泄漏。</p>
<p><em>将<code>ThreadLocal</code>置为<code>null</code>并不能使<code>value</code>被垃圾回收。</em></p>
<p>将引用置为<code>nul</code>可以消除对<code>ThreadLocal</code>的强引用，加上<code>map</code>对<code>ThreadLocal</code>引用是弱引用，所以<code>ThreadLocal</code>实例可以被垃圾回收，</p>
<p>但是对于<code>value</code>而言，始终存在以线程对象为起点的强引用，所以<code>value</code>在线程结束之前一直不能被回收，</p>
<p>这一点在使用线程池的时候要格外注意。</p>
<p><strong>从宏观讲，<code>ThreadLocal</code>只是一个工具类，而不是实际存数据的地方，将其置为<code>null</code>，显然不能释放数据占用的内存。</strong></p>
<p>不过，jdk 也对这个问题作出了一些优化，当调用<code>set</code>或<code>get</code>方法时可能会清理 stale 数据：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>作为开发者，不能依赖 jdk 不及时且不确保一定执行的清理逻辑，最好在使用完毕后显式的调用<code>remove</code>方法；</p>
<p>也可以再封装一层，实现<code>AutoCloseable</code>接口：</p>
...
<span class="token punctuation">}</span> 
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h2 id="aqs" tabindex="-1"><a class="header-anchor" href="#aqs" aria-hidden="true">#</a> AQS</h2>
<p>AQS 即抽象队列同步器内部维护了 FIFO 的类 CLH 队列，并使用变量<code>state</code>标记同步状态（可以代表资源数、锁状态等等）。使用者通过重写<code>tryAcquire</code>、<code>tryRelease</code>等方法来操作<code>state</code>来实现自定义的同步规则。</p>
<p>AQS 提供了：</p>
<ul>
<li>同步状态的原子性管理；</li>
<li>线程的阻塞和解除阻塞；</li>
...
<h3 id="aqs-的基础-clh" tabindex="-1"><a class="header-anchor" href="#aqs-的基础-clh" aria-hidden="true">#</a> AQS 的基础: CLH</h3>
<p>AQS 源码注释：</p>
<blockquote>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>The wait queue is a variant of a "CLH" (Craig, Landin, and Hagersten) lock queue. 
...
<p>正如源码注释所说，AQS 中的等待队列借鉴了 CLH ,都是把一些控制信息放到了自己的前驱节点中。</p>
<p>下面简单实现一个 CLH 锁队列：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CLHLock</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br></div></div><p>结论：CLH 是<code>公平自旋</code>锁</p>
<h2 id="countdownlatch、cyclicbarrier-和-semaphore" tabindex="-1"><a class="header-anchor" href="#countdownlatch、cyclicbarrier-和-semaphore" aria-hidden="true">#</a> CountDownLatch、CyclicBarrier 和 Semaphore</h2>
<h3 id="countdownlatch" tabindex="-1"><a class="header-anchor" href="#countdownlatch" aria-hidden="true">#</a> CountDownLatch</h3>
<p>提供了计数等待的功能，调用了<code>await</code>的线程会等待其他线程将倒计数减到 0 后再执行。</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CountDownLatchDemo</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">InterruptedException</span> <span class="token punctuation">{</span>
...
<p>提供了对共享资源占用的限制。</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SemaphoreDemo</span> <span class="token punctuation">{</span>
		<span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
工人6释放出机器
*/</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br></div></div><h3 id="例子" tabindex="-1"><a class="header-anchor" href="#例子" aria-hidden="true">#</a> 例子</h3>
<p>两个线程交替打印数字和字母，线程 1 打印 1，线程 2 打印 a，线程 1 打印 2，线程 2 打印  b，以此类推...</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AlternatelyPrintSynchronized</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br></div></div><h4 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h4>
<p>可以保证先输出数字吗，如何保证先输出数字</p>
<h4 id="先输出数字" tabindex="-1"><a class="header-anchor" href="#先输出数字" aria-hidden="true">#</a> 先输出数字</h4>
<p>利用 CountDownLatch:</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AlternatelyPrintSynchronized</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br></div></div><h2 id="future-和-completablefuture" tabindex="-1"><a class="header-anchor" href="#future-和-completablefuture" aria-hidden="true">#</a> Future 和 CompletableFuture</h2>
<h3 id="future" tabindex="-1"><a class="header-anchor" href="#future" aria-hidden="true">#</a> Future</h3>
<p>Future 可以更方便的获取其他的线程的返回值。</p>
<p>用线程池提交<code>Callable</code>任务后，会返回一个<code>Future</code>对象，然后，某个时刻调用<code>Future</code>对象的<code>get()</code>方法，就可以获得异步执行的结果。</p>
<p>在调用<code>get()</code>时，如果异步任务已经完成，就直接获得结果。如果异步任务还没有完成，那么<code>get()</code>会阻塞，直到任务完成后才返回结果。</p>
<h3 id="completablefuture" tabindex="-1"><a class="header-anchor" href="#completablefuture" aria-hidden="true">#</a> CompletableFuture</h3>
<p>相比<code>future</code>增加了回调方法，不再阻塞。</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CompletableFutureDemo</span> <span class="token punctuation">{</span>
...
finalRes
*/</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br></div></div><p>另外，<code>CompletableFuture</code>还提供了<code>anyOf</code>和<code>allOf</code>等 api，利用这些 api 可以实现更丰富的异步流程控制。</p>
<h2 id="forkjoin" tabindex="-1"><a class="header-anchor" href="#forkjoin" aria-hidden="true">#</a> ForkJoin</h2>
<p>利用了分治的思想，便于大规模计算：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ForkJoinDemo</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
<h2 id="多线程一定比单线程快吗" tabindex="-1"><a class="header-anchor" href="#多线程一定比单线程快吗" aria-hidden="true">#</a> 多线程一定比单线程快吗</h2>
<p>线程的上下文切换和新线程的创建都是有性能开销的。</p>
<p>如果开启了过多的线程，或者频繁的加锁解锁都有可能降低系统的效率，甚至使系统崩溃。</p>
<p>所以合理的设置线程数至关重要，下面有一些关于线程数设置的小 tips</p>
<h3 id="计算密集型" tabindex="-1"><a class="header-anchor" href="#计算密集型" aria-hidden="true">#</a> 计算密集型</h3>
<p>场景</p>
<ul>
<li>视频解码</li>
<li>数据计算，如三角函数，圆周率</li>
</ul>
<p>一般可设置为</p>
<ol>
<li>核心加1，基于充分利用 cpu 的思想</li>
</ol>
<blockquote>
<p>对于计算密集型的程序，线程数应当等于核心数，但是再怎么计算密集，总有一些IO，所以再加一个线程来把等待IO的CPU时间利用起来</p>
</blockquote>
<ol start="2">
<li>核心数减一，基于服务可用性的思想</li>
</ol>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>// forkJion 源码中的默认线程数为所有核心数减一
ForkJoinPool.commonPool().invoke(task);
// ForkJoinPool.java
parallelism = Runtime.getRuntime().availableProcessors() - 1
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="io-密集型" tabindex="-1"><a class="header-anchor" href="#io-密集型" aria-hidden="true">#</a> IO 密集型</h3>
<p>场景</p>
<ul>
<li>Web应用，如 tomcat 的 maxThreads = 200</li>
</ul>
<p>阻塞系数 = 阻塞时间/(阻塞时间+计算时间)</p>
<p>线程数 = CPU可用核心数/(1 - 阻塞系数）</p>
<p>正常的阻塞系数大概都 0.8，0.9 左右</p>
<h3 id="混合型" tabindex="-1"><a class="header-anchor" href="#混合型" aria-hidden="true">#</a> 混合型</h3>
<p>场景</p>
<ul>
<li>mysql cost</li>
</ul>
<p>mysql 执行计划根据执行成本选择最优路线，具体的算法是 io 一个数据页成本为 1，扫描一个 record 成本为 0.2，如果扫全表的成本低于走索引，mysql 甚至会忽视索引直接扫全表</p>
<p>这个和线程数没关系，但是体现了混合型任务的特征</p>
<h2 id="线程池" tabindex="-1"><a class="header-anchor" href="#线程池" aria-hidden="true">#</a> 线程池</h2>
<h3 id="threadpoolexecutor-参数" tabindex="-1"><a class="header-anchor" href="#threadpoolexecutor-参数" aria-hidden="true">#</a> ThreadPoolExecutor 参数</h3>
<p>（1）corePoolSize：核心线程数，线程池中始终存活的线程数。</p>
<p>（2）maximumPoolSize: 最大线程数，线程池中允许的最大线程数。</p>
<p>（3）keepAliveTime: 存活时间，线程没有任务执行时最多保持多久时间会终止。</p>
<p>（4）unit: 单位，参数keepAliveTime的时间单位，7种可选。</p>
<table>
<thead>
<tr>
<th>参数</th>
...
<tr>
<td>TimeUnit.HOURS</td>
<td>小时</td>
</tr>
<tr>
<td>TimeUnit.MINUTES</td>
<td>分</td>
</tr>
<tr>
...
<p>（6）threadFactory: 线程工厂，主要用来创建线程，默及正常优先级、非守护线程。</p>
<p>（7）handler：拒绝策略，拒绝处理任务时的策略，4种可选，默认为 AbortPolicy。</p>
<table>
<thead>
<tr>
<th>参数</th>
...
<h3 id="线程池的执行规则" tabindex="-1"><a class="header-anchor" href="#线程池的执行规则" aria-hidden="true">#</a> 线程池的执行规则</h3>
<ol>
<li>
<p>当线程数小于核心线程数时，创建线程。</p>
</li>
<li>
<p>当线程数大于等于核心线程数，且任务队列未满时，将任务放入任务队列。</p>
</li>
<li>
<p>当线程数大于等于核心线程数，且任务队列已满：</p>
</li>
</ol>
<blockquote>
...
<h3 id="线程池规范" tabindex="-1"><a class="header-anchor" href="#线程池规范" aria-hidden="true">#</a> 线程池规范</h3>
<p>线程池不允许使用Executors去创建，而是通过 ThreadPoolExecutor 的方式，这样的处理方式让写的同学更加明确线程池的运行规则，规避资源耗尽的风险。</p>
<p>Executors返回的线程池对象的弊端如下:</p>
<p>FixedThreadPool和SingleThreadPool：允许的请求队列长度为Integer.MAX_VALUE，可能会堆积大量的请求，从而导致OOM。</p>
<p>CachedThreadPool和ScheduledThreadPool：允许的创建线程数量为Integer.MAX_VALUE，可能会创建大量的线程，从而导致OOM。</p>
</template>
