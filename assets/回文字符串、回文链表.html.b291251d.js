import{_ as n,o as s,c as a,d as e}from"./app.f6bfe801.js";const t={},p=e(`<h1 id="回文字符串" tabindex="-1"><a class="header-anchor" href="#回文字符串" aria-hidden="true">#</a> 回文字符串</h1><h2 id="描述" tabindex="-1"><a class="header-anchor" href="#描述" aria-hidden="true">#</a> 描述</h2><p>给定一个字符串，验证它是否是回文串，只考虑字母和数字字符，可以忽略字母的大小写。</p><p>说明：本题中，我们将空字符串定义为有效的回文串。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>示例 1:
